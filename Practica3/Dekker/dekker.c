...
int main(int args,char *arg[]){ //Ejecutar programa con sudo para que pueda acceder a la memoria
    ...
    while(10){
        ...
        if(letra_proceso == 'p'){
                getchar();
                memzone->quiere_q = 1;//Puerta de q cerrada y puerta de contienda de p cerrada porque funcionan igual
                ...
                if(memzone->quiere_p == 0){
                    ...
                    printf("He accionado los pulsadores\n");
                }else{
        ...
        if(letra_proceso == 'q'){
                getchar();
                memzone->quiere_p = 1;//Puerta de q cerrada y puerta de contienda de p cerrada porque funcionan igual
                printf("He accionado el pulsador\n");
                getchar();
                printf("Intentando acceder a la seccion critica\n");
